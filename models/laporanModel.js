...
class laporanModel {
    ...
    static async recapitulationDetailReprot(req, res, next) {
        let { year,month } = req.query;
        let query = `select tl.*, tuun.nama_penerima, tuun2.nama_petugas, tu.nama, DATE_FORMAT(tl.created_at, "%d-%m-%Y") as dateformated
